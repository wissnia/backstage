    ...
    (function (global, factory2) {
      ...
      function isNewLine2(code2, ecma2019String) {
        return (
          code2 === 10 ||
          code2 === 13 ||
          (!ecma2019String && (code2 === 8232 || code2 === 8233))
        );
      }
      ...
      function getOptions2(opts) {
        ...
        for (var opt in defaultOptions2) {
          options[opt] =
            opts && has(opts, opt) ? opts[opt] : defaultOptions2[opt];
        }
      ...
      var SCOPE_TOP2 = 1,
        SCOPE_FUNCTION2 = 2,
        SCOPE_VAR2 = SCOPE_TOP2 | SCOPE_FUNCTION2,
        SCOPE_ASYNC2 = 4,
        SCOPE_GENERATOR2 = 8,
        SCOPE_ARROW2 = 16,
      ...
      pp2.isContextual = function (name2) {
        return (
          this.type === types2.name && this.value === name2 && !this.containsEsc
        );
      };
      ...
      pp$12.isAsyncFunction = function () {
        ...
        return (
          ...
          (next + 8 === this.input.length ||
            !isIdentifierChar2(this.input.charAt(next + 8)))
        );
      };
      ...
      pp$12.parseFunctionStatement = function (
        node,
        isAsync,
        declarationPosition,
      ) {
      ...
      pp$12.parseIfStatement = function (node) {
        ...
        node.alternate = this.eat(types2._else)
      ...
      pp$12.parseFor = function (node, init) {
        ...
        this.expect(types2.semi);
        node.update =
          this.type === types2.parenR ? null : this.parseExpression();
        this.expect(types2.parenR);
      ...
      pp$12.parseFunction = function (
        ...
        if (statement & FUNC_STATEMENT2) {
          node.id =
            statement & FUNC_NULLABLE_ID2 && this.type !== types2.name
              ? null
              : this.parseIdent();
      ...
      pp$12.parseClassElement = function (constructorAllowsSuper) {
        ...
        var tryContextual = function (k, noLineBreak) {
          ...
          var start3 = this$1.start,
            startLoc = this$1.startLoc;
          if (!this$1.eatContextual(k)) {
            return false;
          }
          if (
            this$1.type !== types2.parenL &&
        ...
        if (!isGenerator) {
          if (this.options.ecmaVersion >= 8 && tryContextual('async', true)) {
            isAsync = true;
            isGenerator =
              this.options.ecmaVersion >= 9 && this.eat(types2.star);
      ...
      pp$12.parseClassMethod = function (
        method,
        isGenerator,
        isAsync,
        allowsDirectSuper,
      ...
      pp$12.parseClassSuper = function (node) {
        node.superClass = this.eat(types2._extends)
      ...
      pp$22.parseBindingList = function (
        close,
        allowEmpty,
        allowTrailingComma,
      ) {
      ...
      pp$32.parseMaybeAssign = function (
        noIn,
        refDestructuringErrors,
        afterLeftParse,
      ) {
      ...
      pp$32.parseExprOp = function (
        ...
        if (prec != null && (!noIn || this.type !== types2._in)) {
          if (prec > minPrec) {
            var logical =
              this.type === types2.logicalOR || this.type === types2.logicalAND;
            var op = this.value;
            this.next();
            var startPos = this.start,
              startLoc = this.startLoc;
      ...
      pp$32.parseSubscripts = function (base2, startPos, startLoc, noCalls) {
        var maybeAsyncArrow =
          ...
          this.input.slice(base2.start, base2.end) === 'async';
        while (true) {
      ...
      pp$32.parseSubscript = function (
        ...
        if (computed || this.eat(types2.dot)) {
          ...
          var exprList = this.parseExprList(
            types2.parenR,
            this.options.ecmaVersion >= 8 && base2.type !== 'Import',
            false,
            refDestructuringErrors,
          );
          if (
      ...
      pp$32.parseExprAtom = function (refDestructuringErrors) {
        ...
        switch (this.type) {
          ...
          case types2._false:
            node = this.startNode();
            node.value =
              this.type === types2._null ? null : this.type === types2._true;
      ...
      pp$32.parseParenAndDistinguishExpression = function (canBeArrow) {
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          while (this.type !== types2.parenR) {
            ...
            if (
              allowTrailingComma &&
              this.afterTrailingComma(types2.parenR, true)
            ) {
              lastIsComma = true;
              break;
            } else if (this.type === types2.ellipsis) {
      ...
      pp$32.parsePropertyValue = function (
        prop,
        isPattern,
        isGenerator,
        isAsync,
      ...
      pp$72.braceIsBlock = function (prevType) {
        ...
        if (
          ...
          (prevType === types2.name && this.exprAllowed)
        ) {
        ...
        if (
          prevType === types2._var ||
          prevType === types2._const ||
          prevType === types2.name
        ) {
          return false;
        }
      ...
      types2.braceL.updateContext = function (prevType) {
        this.context.push(
          this.braceIsBlock(prevType) ? types$12.b_stat : types$12.b_expr,
        );
        this.exprAllowed = true;
      };
      ...
      types2._function.updateContext = types2._class.updateContext = function (
        prevType,
      ) {
        if (
          prevType.beforeExpr &&
      ...
      function buildUnicodeData2(ecmaVersion) {
        var d = (data2[ecmaVersion] = {
          binary: wordsRegexp2(
            unicodeBinaryProperties2[ecmaVersion] +
              ' ' +
      ...
      pp$82.regexp_pattern = function (state) {
        ...
        for (
          var i = 0, list3 = state.backReferenceNames;
          i < list3.length;
          i += 1
        ) {
          var name2 = list3[i];
      ...
      pp$82.regexp_validateUnicodePropertyNameAndValue = function (
        state,
        name2,
        value,
      ) {
      ...
      pp$82.regexp_validateUnicodePropertyNameOrValue = function (
        state,
        nameOrValue,
      ) {
      ...
      pp$92.skipBlockComment = function () {
        ...
        if (this.options.locations) {
          ...
          var match;
          while (
            (match = lineBreakG2.exec(this.input)) &&
      ...
      pp$92.readToken_pipe_amp = function (code2) {
        ...
        if (next === code2) {
          return this.finishOp(
            code2 === 124 ? types2.logicalOR : types2.logicalAND,
            2,
          );
        }
        if (next === 61) {
        ...
        return this.finishOp(
          code2 === 124 ? types2.bitwiseOR : types2.bitwiseAND,
          1,
        );
      };
      ...
      pp$92.getTokenFromCode = function (code2) {
        ...
        this.raise(
          this.pos,
          "Unexpected character '" + codePointToString$12(code2) + "'",
        );
      };
        ...
        if (
          ...
          val =
            typeof BigInt !== 'undefined'
              ? BigInt(this.input.slice(start3, this.pos))
              : null;
          ++this.pos;
      ...
      pp$92.readTmplToken = function () {
        ...
        for (;;) {
          ...
          if (
            ...
            if (
              this.pos === this.start &&
              (this.type === types2.template ||
                this.type === types2.invalidTemplate)
            ) {
              if (ch === 36) {
                this.pos += 2;
...
// ../../node_modules/micromark-extension-mdxjs/node_modules/micromark-extension-mdx-expression/lib/syntax.js
...
// ../../node_modules/micromark-extension-mdxjs/node_modules/micromark-extension-mdx-jsx/lib/factory-tag.js
var lazyLineEnd = {
...
// ../../node_modules/micromark-extension-mdxjs/node_modules/micromark-extension-mdx-jsx/lib/jsx-text.js
...
// ../../node_modules/micromark-extension-mdxjs/node_modules/micromark-extension-mdx-jsx/lib/jsx-flow.js
...
// ../../node_modules/micromark-extension-mdxjs/node_modules/micromark-extension-mdx-jsx/lib/syntax.js
...
// ../../node_modules/micromark-extension-mdxjs/node_modules/micromark-extension-mdx-md/index.js
var mdxMd = {
...
function mdxjsEsm(options) {
  ...
  function tokenizeExportImport(effects, ok2, nok) {
    ...
    function rest(code2) {
      ...
      if (markdownLineEnding(code2)) {
        return effects.check(nextBlankConstruct, atEnd, atEol)(code2);
      }
      effects.consume(code2);
      return rest;
    }
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/attention.js
var attention = {
  name: 'attention',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/autolink.js
var autolink = {
  name: 'autolink',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/blank-line.js
var blankLine2 = {
  tokenize: tokenizeBlankLine2,
  partial: true,
};
function tokenizeBlankLine2(effects, ok2, nok) {
  return factorySpace(effects, afterWhitespace, 'linePrefix');
  function afterWhitespace(code2) {
    return code2 === null || markdownLineEnding(code2)
      ? ok2(code2)
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/block-quote.js
var blockQuote = {
  name: 'blockQuote',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/character-escape.js
var characterEscape = {
...
// ../../node_modules/mdast-util-from-markdown/node_modules/parse-entities/decode-entity.js
var own6 = {}.hasOwnProperty;
function decodeEntity(characters) {
  return own6.call(characterEntities, characters)
    ? characterEntities[characters]
    : false;
}

// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/character-reference.js
...
function tokenizeCharacterReference(effects, ok2, nok) {
  ...
  function value(code2) {
    ...
    if (code2 === 59 && size) {
      ...
      if (
        test === asciiAlphanumeric &&
        !decodeEntity(self2.sliceSerialize(token))
      ) {
        return nok(code2);
      }
      effects.enter('characterReferenceMarker');
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/code-fenced.js
var codeFenced = {
  name: 'codeFenced',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/code-indented.js
var codeIndented = {
  name: 'codeIndented',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/code-text.js
var codeText = {
  name: 'codeText',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/content.js
var content2 = {
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/definition.js
var definition = {
  name: 'definition',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/hard-break-escape.js
var hardBreakEscape = {
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/heading-atx.js
var headingAtx = {
  name: 'headingAtx',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/html-flow.js
var htmlFlow = {
  name: 'htmlFlow',
...
function tokenizeNextBlank2(effects, ok2, nok) {
  ...
  function start3(code2) {
    ...
    effects.consume(code2);
    effects.exit('lineEndingBlank');
    return effects.attempt(blankLine2, ok2, nok);
  }
}

// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/html-text.js
var htmlText = {
  name: 'htmlText',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/label-end.js
var labelEnd = {
  name: 'labelEnd',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/label-start-image.js
var labelStartImage = {
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/label-start-link.js
var labelStartLink = {
  name: 'labelStartLink',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/line-ending.js
var lineEnding = {
  name: 'lineEnding',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/thematic-break.js
var thematicBreak = {
  name: 'thematicBreak',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/list.js
var list = {
  name: 'list',
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-core-commonmark/lib/setext-underline.js
var setextUnderline = {
...
// ../../node_modules/micromark-util-decode-string/node_modules/parse-entities/decode-entity.js
var own7 = {}.hasOwnProperty;
function decodeEntity2(characters) {
  return own7.call(characterEntities, characters)
    ? characterEntities[characters]
    : false;
}
...
function extension(combined, extension2) {
  ...
  for (key in extension2) {
    if (own8.call(extension2, key)) {
      ...
      const maybe = own8.call(combined, key) ? combined[key] : void 0;
...
function unknown(h, node) {
  ...
  if (
    'value' in node &&
    !(
      own9.call(data2, 'hName') ||
      own9.call(data2, 'hProperties') ||
      own9.call(data2, 'hChildren')
    )
  ) {
...
function definitions(node) {
  ...
  function ondefinition(definition2) {
    ...
    if (id && !own10.call(cache, id)) {
      cache[id] = definition2;
    }
  }
  function getDefinition(identifier) {
    const id = clean(identifier);
    return id && own10.call(cache, id) ? cache[id] : null;
  }
}
...
function imageReference(h, node) {
  ...
  const props = {
    src: (0, import_encode.default)(def.url || ''),
    alt: node.alt,
  };
  ...
  constructor(property, attribute, mask, space) {
    ...
    while (++index2 < checks.length) {
      mark(
        this,
        checks[index2],
        (mask & types_exports[checks[index2]]) ===
          types_exports[checks[index2]],
      );
    }
  }
};
...
function zwitch(key, options) {
  ...
  function one3(value) {
    ...
    if (value && own14.call(value, key)) {
      fn = own14.call(handlers2, value[key])
        ? handlers2[value[key]]
        : one3.unknown;
    }
    if (fn) {
...
function toEstree(tree, options = {}) {
  ...
  if (result) {
    ...
    body.push(
      create4(tree, { type: 'ExpressionStatement', expression: result }),
    );
  }
  return create4(tree, {
    type: 'Program',
...
function createProcessor(options = {}) {
  ...
  pipeline
    ...
    .use(remarkPlugins || [])
    .use(lib_default, { allowDangerousHtml: true, passThrough: nodeTypes })
    .use(rehypePlugins || []);
  if (format === 'md') {
